...
#Korrekturen
wave_3$education[wave_3$höchste.Ausbildung=="XX"]<-NA 
wave_3$German_ok[is.na(wave_3$Deutschkenntnisse)]<-1
wave_3$nationality_AUT[wave_3$Nation=="X"]<-NA 

wave_3=wave_3%>%select(personal_id,
                counselor_id,
                rgs_id,
                nationality_AUT, 
                male,
